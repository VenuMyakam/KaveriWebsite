                ...
                <div class="info-ribbon-wrap info-ribbon-brand-red">
                    <div class="info-ribbon">
                        <div class="info-ribbon-content">
                            ...
                            <ul class="text-start">
                                <li>Preparing new-gen students to be globally relevant and responsible leaders.</li>
                                <li>Ensuring diversity and inclusivity in learning and opportunity.</li>
                                <li>Providing relevant curricula to foster students’ knowledge, skills, and dispositions for thoughtful and engaged citizenship.</li>
                                <li>Promoting impactful research for generating new knowledge and technologies to meet stakeholder needs.</li>
                                <li>Applying lifelong learning concept and catalyze building holistic, equitable societies and sustainable ecosystems.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="info-ribbon-bottom"></div>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-kaveri-advantage" role="tabpanel" aria-labelledby="pills-kaveri-advantage-tab">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                      <div class="arrows-advantage-slider">
                            ...
                            <!-- culture -->
                            <div class="tab-pane fade" id="pills-campus-life" role="tabpanel" aria-labelledby="pills-campus-life-tab">
                                <div class="info-content mb-md-4 mb-3">
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="info-tab-title h4 fw-bold text-brand-blue text-uppercase header-line">Campus Life</h3>
                                        </div>
                                        <div class="col-auto">
                                            <div class="arrows-culture-slider">
                                    ...
                                    <?php $arguments = [
                                        ...
                                        'tax_query' => array(
                                            array(
                                                'taxonomy' => 'academics_categories', // Taxonomy, in my case I need default post categories
                                                'field'    => 'slug',
                                                'terms'    => 'campus-life', // Your category slug (I have a category 'interior')
                                            )
                                        )
                                    ];
                            ...
                            <div class="tab-pane fade" id="pills-programmes" role="tabpanel" aria-labelledby="pills-programmes-tab">
                                <div class="info-content mb-md-4 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="arrows-academics-slider">
